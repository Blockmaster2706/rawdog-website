...
describe('CustomFileSystem Unit Tests', () => {
    ...
    describe('getNodeByPath', () => {
        ...
        it('should find deeply nested files', () => {
            const deepFile = fileSystem.getNodeByPath('~/documents/subfolder/file2.txt');
        ...
        it('should return null for non-existent nested paths', () => {
            const nonExistent = fileSystem.getNodeByPath('~/documents/nonexistent/file.txt');
            expect(nonExistent).to.be.null;
        });
    });
    ...
    describe('listDirectory', () => {
        ...
        it('should list root directory contents', () => {
            ...
            expect(contents).to.deep.equal(['file1.txt', 'file2.txt', 'subdirectory', 'emptydir']);
        });
    ...
    describe('Integration Tests', () => {
        it('should handle complex file system operations', () => {
            ...
            expect(fileSystem.listDirectory('~/home/user')).to.deep.equal(['documents']);
...
//# sourceMappingURL=CustomFileSystem.cy.js.map